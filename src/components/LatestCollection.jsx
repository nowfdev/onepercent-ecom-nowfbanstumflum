    ...
    <div className="my-10">
      <div className="text-center py-8 text-3xl">
        ...
        <p className="w-3/4 m-auto text-sx sm:text-sm md:text-base text-gray-600">
          ...
          consequuntur maxime iusto mollitia temporibus! Officia asperiores
          accusantium sequi nisi quis aspernatur, eius, voluptatibus aliquid
          ratione soluta aperiam quod iste?
        </p>
      </div>
